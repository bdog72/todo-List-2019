...
document.getElementById('clearItemButton').onclick = function () {
...
for (var i = 0; i < displayTodoList.length; i++) {
...
var _loop = function _loop(_i) {
  taskItems[_i].onclick = function () {
    taskItems[_i].classList.add('task-complete');
  };
};

for (var _i = 0; _i < taskItems.length; _i++) {
  _loop(_i);
}
...
//# sourceMappingURL=/todo-List-2019.e31bb0bc.map